...
function HomePage() {
  return (
    ...
    <h1 className="mb-4 text-3xl font-extrabold text-cyan-600 tracking-tight leading-none md:text-3xl lg:text-6xl dark:text-white">Explore our world’s potentials with <br /><span className='self-center text-5xl mb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r to-purple-600 from-sky-400 underline underline-offset-1 decoration-8 decoration-blue-400 dark:decoration-blue-600'>"Global Escapades" <br /></span>Your Passport to Beauty</h1>
    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">"Embark on a journey of discovery with Global Escapades, your passport to the world's most breathtaking destinations. Immerse yourself in the beauty, culture, and wonders of global landscapes—all from the comfort of your screen."</p>
